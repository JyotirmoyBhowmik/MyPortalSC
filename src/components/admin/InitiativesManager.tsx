                        ...
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="border-b border-border text-left">
                                    ...
                                    {allowDragDrop && <th className="px-4 py-3 font-semibold text-muted-foreground w-8"></th>}
                                </tr>
                            </thead>
                                ...
                                >
                                    <SortableContext items={filtered} strategy={verticalListSortingStrategy}>
                                        {filtered.map((init, idx) => (
                                            <SortableRow key={init.id} id={init.id} className="hover:bg-surface/50 transition-colors" disabled={!allowDragDrop}>
