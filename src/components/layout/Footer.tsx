...
const socialLinks = [
    {
        href: "https://github.com/JyotirmoyBhowmik",
        label: "GitHub",
        icon: (
    ...
    {
        href: "https://www.linkedin.com/in/jyotirmoybhowmik/",
        label: "LinkedIn",
        icon: (
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="flex gap-3">
                            {socialLinks.map((social) => (
                                <a
                                    ...
                                    className="p-2.5 rounded-lg bg-muted text-muted-foreground hover:text-primary hover:bg-primary/10 transition-all"
