...
export default function NavbarCeramic({ flags }: { flags: Record<string, boolean> }) {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden bg-surface border-b border-border shadow-lg" id="mobile-menu">
